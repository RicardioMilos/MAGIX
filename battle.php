...
<iframe id="chat-container" style="width:700px;height:240px;" onload="applyStyles(this)"
    src="https://magix.apps-de-cours.com/server/#/chat/<?=$_SESSION["key"]?>"> 
</iframe>

<div class="enemy-container">
    <div class="enemy-hand">
        <ul id="op-handContainer">
        </ul>
    </div>
...
<div class="user-container">
    ...
    <div class="action-container">
        <div>
            <input type="submit" id="power-Btn" name="POWER" value="POWER" onclick="usePower()"/>
        </div>
        <div>
            <input type="submit" id="skip-Btn" name="SKIP" value="SKIP" onclick="skipTurn()"/>
        </div>
        <div>
            <input type="submit" id="chat-Btn" name="CHAT" value="CHAT" onclick="toggleChat()"/>
        </div>
